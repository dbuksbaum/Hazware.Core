...
{
  public sealed class NLogLogger<T> : AbstractLogger
  {
    #region Fields
    private readonly Logger _log = LogManager.GetLogger(typeof(T).Name);
    #endregion
    ...
    {
      _log.DebugException(string.Format(message, args), exception);
    }
    ///<summary>
    ...
    {
      _log.InfoException(string.Format(message, args), exception);
    }
    ///<summary>
    ...
    {
      _log.WarnException(string.Format(message, args), exception);
    }
    ///<summary>
    ...
    {
      _log.ErrorException(string.Format(message, args), exception);
    }
    ///<summary>
    ...
    {
      _log.FatalException(string.Format(message, args), exception);
    }
    #endregion
  }
}
